...
const Livematch = () => {
    ...
    const matchData = [
        {
            ...
            teams: [
              {
                ...
                logo: "https://v3.traincdn.com/resized/size16/sfiles/logo_teams/a50881633802113bfbdce59391450fe3.webp",
                score: 0,
              },
              {
                name: "Eastern Cape Linyathi",
                logo: "https://v3.traincdn.com/resized/size16/sfiles/logo_teams/7fa55defd1651e464968637341f1c0f1.webp",
                score: 0,
              },
            ],
            odds: [
          ...
          },
          {
            ...
            teams: [
              {
                name: "South Africa Emerging Team",
                logo: "https://v3.traincdn.com/resized/size16/sfiles/logo_teams/746d106dcf9f266ddf1c8152ea6e519b.webp",
                score: 0,
              },
              {
                name: "Eastern Cape Linyathi",
                logo: "https://v3.traincdn.com/resized/size16/sfiles/logo_teams/80b4c04fdc181563bdafac5fb62dbf86.webp",
                score: 0,
              },
            ],
            odds: [
  ...
  return (
    <section className='py-[20px] w-full bg-gray-300 p-2'>
      <Toaster/>
                        ...
                        <div className="w-full bg-white shadow-sm  p-3 text-gray-800">
                          ...
                          <div className="grid grid-cols-5 gap-1 mt-3 text-center text-xs">
                            {matchData.odds.map((odd, index) => (
                              <div key={index} onClick={handlealert}  className="bg-gray-200 cursor-pointer p-2 rounded-md">
