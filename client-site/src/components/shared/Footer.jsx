  ...
  return (
    <div>
      <div className="p-3 space-y-3">
        ...
        <div className="flex gap-3 w-full text-[#c2c2c2]">
          <div className="p-4 text-sm bg-[#212121] rounded-md">
            <p>
          ...
          <div className="p-4 flex gap-3 items-center justify-center bg-[#212121] rounded-md">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <div className="p-4 text-2xl text-center font-semibold bg-[#212121] rounded-md">
                18+
              </div>
            </div>
            <Link>
              <div className="py-1.5 px-2 text-sm font-medium text-center bg-[#212121] hover:bg-[#424141] duration-300 rounded-md uppercase">
                Mobile version
              </div>
            </Link>
          </div>
